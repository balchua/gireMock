...
public abstract class Generator {
     ...
     */
    @Deprecated()
    public Stream<PluginProtos.CodeGeneratorResponse.File> generate(PluginProtos.CodeGeneratorRequest request) throws io.giremock.generator.GeneratorException {
        return Stream.empty();
    }
